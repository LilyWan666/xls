...
// // Pass which adds inverter after every node.
// class AddInverterPass : public FunctionBasePass {
//  public:
//   AddInverterPass()
//       : FunctionBasePass("add_inverter", "Add inverter nodes") {}
...
class AddInverterPass : public FunctionBasePass {
 public:
  AddInverterPass() : FunctionBasePass("add_inverter", "Add inverter nodes") {}
  ~AddInverterPass() override = default;
